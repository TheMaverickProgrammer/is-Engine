...
void Bonus::step(float const &DELTA_TIME)
{
    ...
    m_sprParent.setPosition(m_x + 16.f, m_y + 8.f + is::lengthDirY(3.5f, m_oscillation));
    m_sprParent.setScale(m_imageScale, m_imageScale);
    m_sprParent.setColor(sf::Color(255, 255, 255, m_imageAlpha));
}
