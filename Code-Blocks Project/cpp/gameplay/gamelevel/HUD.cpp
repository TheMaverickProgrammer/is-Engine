...
HUD::HUD(unsigned int &playerHealth, is::GameDisplay &scene) :
    m_score(0),
    m_scene(scene),
...
void HUD::step(float const &DELTA_TIME, GameTime &gameTime, Player &player, bool &levelComplete)
{
    ...
    m_txtHealth.setString("Health : " + is::writeZero(m_playerHealth));
