...
void Player::step(GameSystemExtended &gameSysExt, float const &DELTA_TIME, GameKeyData &gameKey, int const &health,
...
bool Player::placeMetting(int x, int y, Bloc const *other)
{
...
bool Player::placeMetting(int x, int y, Enemy const *other)
{
    is::Rectangle testRec = this->getMask();
