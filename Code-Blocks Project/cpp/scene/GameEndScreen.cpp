...
GameEndScreen::GameEndScreen(sf::RenderWindow &window, sf::View &view, sf::RenderTexture &surface, DisplayOption &m_launchOption, GameSystemExtended& GameSystemExtended):
...
bool GameEndScreen::loadResources()
{
    ...
    float txtY(180.f);
    is::createWText(m_fontTitle, m_txtEndTitle, lang::end_msg_congrat[m_gameSysExt.m_gameLanguage], 0.f, 0.f, sf::Color(0, 0, 0), 48);
    is::centerSFMLObj(m_txtEndTitle);
    is::setSFMLObjX_Y(m_txtEndTitle, m_viewX, m_viewY - txtY);
    is::createWText(m_fontMsg, m_txtEndMsg, lang::end_msg_sentences[m_gameSysExt.m_gameLanguage], 32.f, m_viewY - (txtY - 80.f), sf::Color(0, 0, 0), 26);
    ...
    is::createText(m_fontSystem, m_txtQuitScreen, lang::pad_main_menu[m_gameSysExt.m_gameLanguage],
